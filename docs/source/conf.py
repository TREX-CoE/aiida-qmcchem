# -*- coding: utf-8 -*-
#
# Sphinx configuration for qmcchem
#
...
html_use_opensearch = 'http://aiida-qmcchem.readthedocs.io'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'qmcchem')
